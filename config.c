...
const uint8_t MAIN_PAYLOAD[MAIN_PAYLOAD_LEN_DEF][8]={
    ...
    {REPORT_ID_KEYBOARD,0x00,DUCK_KEY_2,0,0,0,0,0},
    {REPORT_ID_KEYBOARD,0x00,DUCK_KEY_3,0,0,0,0,0},
    {REPORT_ID_KEYBOARD,0x00,DUCK_KEY_4,0,0,0,0,0},
    {REPORT_ID_KEYBOARD,0x00,DUCK_KEY_5,0,0,0,0,0},
    {REPORT_ID_KEYBOARD,0x00,DUCK_KEY_6,0,0,0,0,0},
    {REPORT_ID_KEYBOARD,0x00,DUCK_KEY_7,0,0,0,0,0},
    {REPORT_ID_KEYBOARD,0x00,DUCK_KEY_8,0,0,0,0,0},
    {REPORT_ID_KEYBOARD,0x00,DUCK_KEY_9,0,0,0,0,0},
